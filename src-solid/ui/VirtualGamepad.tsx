...
// Expose on window for legacy code interop
declare global {
  interface Window {
    __virtualGamepad?: {
      get: () => VirtualGamepadState;
      set: (state: Partial<VirtualGamepadState>) => void;
      reset: () => void;
    };
  }
}
...
window.__virtualGamepad = {
  get: getVirtualGamepadState,
  set: setVirtualGamepadState,
  reset: resetVirtualGamepadState,
};
