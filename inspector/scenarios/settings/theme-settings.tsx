...
export default defineScenario({
  ...
  name: 'Theme selector',
  type: 'contract',
  sourceFiles: ['src/ui/settings/ThemeSettings.tsx', 'src/editors/themes.ts'],
  description:
    'Theme preview grid showing all available themes with live CodeMirror previews. ' +
    'Each card renders real syntax-highlighted code in its theme.',
  component: {
    render: () => (
