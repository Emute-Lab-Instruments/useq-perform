...
- `scripts/build-assets.mjs` — copies markdown/reference/wasm/fonts into `public/`; also runs the two Engine Ledger harvests below (and watches their source dirs in `--watch` mode).
