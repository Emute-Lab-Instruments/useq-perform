...
- `src/editors/commands/actionHandlers.ts` — `mainMenu.*` action handlers (open/close/next/prev/select/back/adjust); `mainMenu.open` force-closes active sub-modes per §1.4
